		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#raumreservierung-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"raumreservierung-display": {
								"semanticObject": "raumreservierung",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=raumreservierung",
									"url": sap.ui.require.toUrl("raumreservierung")
								}
							}
						}
					}
